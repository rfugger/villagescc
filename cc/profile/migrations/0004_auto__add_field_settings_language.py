...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Settings.language'
        db.add_column('profile_settings', 'language',
                      self.gf('cc.general.models.VarCharField')(default='en', max_length=8),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Settings.language'
        db.delete_column('profile_settings', 'language')
    ...
    models = {
        ...
        'profile.passwordresetlink': {
            'Meta': {'object_name': 'PasswordResetLink'},
            'code': ('cc.general.models.VarCharField', [], {'unique': 'True', 'max_length': '1000000000'}),
        ...
        'profile.settings': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language': ('cc.general.models.VarCharField', [], {'default': "'en'", 'max_length': '8'}),
