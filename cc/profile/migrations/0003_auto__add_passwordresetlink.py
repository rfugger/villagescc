...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PasswordResetLink'
        db.create_table('profile_passwordresetlink', (
        ...
        db.send_create_signal('profile', ['PasswordResetLink'])

    def backwards(self, orm):
        # Deleting model 'PasswordResetLink'
        db.delete_table('profile_passwordresetlink')
