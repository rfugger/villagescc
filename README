...
Source for [Villages.cc](https://villages.cc/).  
The code is licensed under the [AGPL v3](https://www.gnu.org/licenses/agpl-3.0.html).
...
You'll need to create a file cc/settings/local.py containing the following Django
settings:
